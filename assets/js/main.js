...
$.getJSON(`${fullBackendAddress + version.toLowerCase()}_quote_serializer.php`)
  ...
  .done(function(data) {
    ...
    $.getJSON(`${fullBackendAddress}colour_serializer.php`).done(function(data) {
      ...
      $.getJSON(`${fullBackendAddress}settings_serializer.php`).done(function(data) {
        ...
        moodEngine.switchVersion = function() {
          ...
          $.getJSON(`${fullBackendAddress + version.toLowerCase()}_quote_serializer.php`).done(function(data) {
