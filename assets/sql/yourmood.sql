...
INSERT INTO `colours` (`id`, `active`, `colour`, `notes`) VALUES
(23, 1, 'DC143C', ''),
(24, 1, 'DB7093', ''),
(25, 1, 'FF69B4', ''),
(26, 1, 'FF1493', ''),
...
INSERT INTO `decrease` (`id`, `active`, `quote`, `notes`) VALUES
...
INSERT INTO `improve` (`id`, `active`, `quote`, `notes`) VALUES
...
INSERT INTO `settings` (`id`, `active`, `setting`, `value`, `user`, `optional`, `advanced`, `mobile`, `input`, `options`, `tab`, `min`, `max`, `label`, `description`, `notes`) VALUES
